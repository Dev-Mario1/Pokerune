...
IMAGE_FILENAME = "assets\Fondos\Pantalla de titulo.png"
FPS = 60
...
# Cargar fondo
try:
    bg = pygame.image.load(IMAGE_FILENAME)
except:
...
play_rect = pygame.Rect(WIDTH//2 - button_w//2, HEIGHT//2 + 220, button_w, button_h)
